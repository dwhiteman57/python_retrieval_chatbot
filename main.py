...
class ChatBot:
    ...
    # define .chat() below:
    def chat(self):
        user_message = input("Welcome to the Chicago Cantina. How can I help you?\n")
    ...
    def find_intent_match(self, responses, user_message):
        ...
        similarity_list = [compare_overlap(word, bow_user_message) for word in processed_responses]
